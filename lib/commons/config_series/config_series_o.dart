...
class ConfigSeriesO extends ConfigSeries<OrdinalGroup, OrdinalData, String> {
  ...
  @override
  common.Series<OrdinalData, String> getRender(OrdinalGroup group,
      ConfigSeries<OrdinalGroup, OrdinalData, String> configSeries) {
    Color groupColor = group.color ??
        Colors.primaries[math.Random().nextInt(Colors.primaries.length)];
    return common.Series<OrdinalData, String>(
      id: group.id,
      data: group.data,
