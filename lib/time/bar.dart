...
/// Time Bar Chart\
class DChartBarT extends StatelessWidget {
  /// group
  ...
  /// style bar
  final ConfigRenderBarT configRenderBar;
  ...
  const DChartBarT({
    ...
    this.configRenderBar = const ConfigRenderBarT(),
  ...
  Widget build(BuildContext context) {
    return charts.TimeSeriesChart(
      ...
      defaultRenderer: configRenderBar.getRender(ChartType.bar.name),
